...
@RestController
@RequestMapping(path = "/Inplace_Message")
public class InplaceMessage {
	...
	@RequestMapping(value = "/Inplace_NuovoMessaggio", method = RequestMethod.POST, consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
	public String issueNewVoucher(@Valid @RequestBody InplaceMessagebeanNuovo body) throws JsonProcessingException {
...
//		customFields.addProperty("value", body.getValue());
		...
		customFields.addProperty("nuovoAlert", body.getNuovoAlert());
		customFields.addProperty("tipo_oprazione", "Nuovo Messaggio nel Fascicolo");
		
		log.debug("Custom Fields: " + customFields.toString());
		AssetParamsJsonMessageNuovo assetCustomFields = gson.fromJson(customFields.toString(), AssetParamsJsonMessageNuovo.class);
	...
	@RequestMapping(value = "/Inplace_NuovoAlert", method = RequestMethod.POST, consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
	public String issueNewVoucherAlert(@Valid @RequestBody InplaceMessagebean body) throws JsonProcessingException {
		log.trace("----- Issue.issueNewVoucher -----");
		log.trace("BODY: " + body.toString());
...
//		customFields.addProperty("value", body.getValue());
		...
		customFields.addProperty("idMessaggioAlert", body.getIdMessaggioAlert());
		customFields.addProperty("descrizione", body.getDescrizione());
		customFields.addProperty("tipo_oprazione", "Nuovo Alert nel Fascicolo");
		
		log.debug("Custom Fields: " + customFields.toString());
		AssetParamsJsonMessage assetCustomFields = gson.fromJson(customFields.toString(), AssetParamsJsonMessage.class);
	...
	@RequestMapping(value = "/Inplace_ModificaMessaggio", method = RequestMethod.POST, consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
	public String issueNewVoucherModifica(@Valid @RequestBody InplaceMessagebean body) throws JsonProcessingException {
		log.trace("----- Issue.issueNewVoucher -----");
		log.trace("BODY: " + body.toString());
...
//		customFields.addProperty("value", body.getValue());
		...
		customFields.addProperty("idMessaggioAlert", body.getIdMessaggioAlert());
		customFields.addProperty("descrizione", body.getDescrizione());
		customFields.addProperty("tipo_oprazione", "Modifica Messaggio nel Fascicolo");
	...
	@RequestMapping(value = "/Inplace_ModificaAlert", method = RequestMethod.POST, consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
	public String issueNewVoucherModificaAlert(@Valid @RequestBody InplaceMessagebean body) throws JsonProcessingException {
		log.trace("----- Issue.issueNewVoucher -----");
		log.trace("BODY: " + body.toString());
...
//		customFields.addProperty("value", body.getValue());
		...
		customFields.addProperty("idMessaggioAlert", body.getIdMessaggioAlert());
		customFields.addProperty("descrizione", body.getDescrizione());
		customFields.addProperty("tipo_oprazione", "Modifica Alert nel Fascicolo");
