...
import com.vantea.hoperay.multichainwrapper.services.beans.AssetParamsNuovoScoringFascicolo;
...
import com.vantea.hoperay.multichainwrapper.services.beans.input.Nuovoscoringfascicolobean;
...
@RestController
@RequestMapping(path = "/Inplace_NuovoScoringFascicolo")

public class NuovoScoringFascicolo {
	...
	@RequestMapping(value = "/Inplace_NuovoScoringFascicolo", method = RequestMethod.POST, consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
	public String issueNewVoucher(@Valid @RequestBody Nuovoscoringfascicolobean body) throws JsonProcessingException {
...
//			customFields.addProperty("value", body.getValue());
			...
			customFields.addProperty("scoreOld", body.getScoreOld());
			customFields.addProperty("scoreNew", body.getScoreNew());
			customFields.addProperty("idFascicolo", body.getIdFascicolo());
			customFields.addProperty("descrizione", body.getDescrizione());
			customFields.addProperty("tipo_oprazione", "Nuovo Scoring del Fascicolo");
			 		
			log.debug("Custom Fields: " + customFields.toString());
			AssetParamsNuovoScoringFascicolo assetCustomFields = gson.fromJson(customFields.toString(), AssetParamsNuovoScoringFascicolo.class);
