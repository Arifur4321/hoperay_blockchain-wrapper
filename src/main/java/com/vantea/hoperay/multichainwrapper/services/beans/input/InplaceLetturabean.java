...
public class InplaceLetturabean {
	...
	public String toString() {
		return "InplaceLetturabean [address_to=" + address_to + ", userName=" + userName + ", idFascicolo="
				+ idFascicolo + ", idMessaggioAlert=" + idMessaggioAlert + ", statoLettura=" + statoLettura
				+ ", statoCancellazione=" + statoCancellazione + ", descrizione=" + descrizione + "]";
	}
